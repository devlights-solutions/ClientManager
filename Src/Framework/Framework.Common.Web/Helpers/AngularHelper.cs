...
//using Framework.Common.Web.Utilities;
...
//    public static class AngularFormHelper
//    {
...
//        public static IHtmlString NgCheckBoxFor<TModel, TProperty>(this HtmlHelper<TModel> _helper, Expression<Func<TModel, TProperty>> expression)
//        {
//            return NgCheckBoxFor(_helper, expression, null);
//        }
...
//        /// <returns>An HTML input element whose type attribute is set to "checkbox" for each property in the object that is represented by the expression.</returns>
//        public static IHtmlString NgCheckBoxFor<TModel, TProperty>(this HtmlHelper<TModel> _helper, Expression<Func<TModel, TProperty>> expression, object htmlAttributes)
//        {
//            return NgCheckBoxFor(_helper, expression, HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes));
//        }
...
//        /// <returns>An HTML input element whose type attribute is set to "checkbox" for each property in the object that is represented by the expression.</returns>
//        public static IHtmlString NgCheckBoxFor<TModel, TProperty>(this HtmlHelper<TModel> _helper, Expression<Func<TModel, TProperty>> expression, IDictionary<string, object> htmlAttributes)
//        {
...
//        public static string GetElementFormIdentifier(string propertyIdentifier)
//        {
...
//        public static string GetElementIdentifier(string expressionText)
//        {
//            return string.Format("{0}{1}",
...
//        private static AngularTagBuilder CreateTagBuilder<TModel, TProperty>(Expression<Func<TModel, TProperty>> expression, string tagName, IDictionary<string, object> htmlAttributes, ModelMetadata metadata)
//        {
//            var tagBuilder = new AngularTagBuilder(tagName);
...
//        private static IHtmlString Input<TModel, TProperty>(Expression<Func<TModel, TProperty>> expression, string type, IDictionary<string, object> htmlAttributes = null, ModelMetadata metadata = null)
//        {
...
//    {
//        public static IHtmlString AngularDropdownFor<TModel, TValue>(this HtmlHelper<TModel> helper,
//            Expression<Func<TModel, TValue>> expression, string modelPrefix, string ngOptions, string emptyElementText, IDictionary<string, object> htmlAttributes)
//        {
...
//        private TagBuilder CreateTagBuilder<TModel, TProperty>(Expression<Func<TModel, TProperty>> expression, string tagName, IDictionary<string, object> htmlAttributes, ModelMetadata metadata)
//        {
...
//        public IHtmlString Dropdown<TProperty>(this HtmlHelper helper, Expression<Func<TModel, TProperty>> expression,)
//        {
//            var metadata = ModelMetadata.FromLambdaExpression(expression, helper.ViewData);
//            var tagBuilder = CreateTagBuilder(expression, "select", htmlAttributes, metadata);
//            if (!string.IsNullOrEmpty(ngOptions))
